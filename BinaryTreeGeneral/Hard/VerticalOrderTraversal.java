...
public class VerticalOrderTraversal {
        ...
        public List<List<Integer>> verticalTraversal(TreeNode root) {
            ...
            while (!queue.isEmpty()) {
                ...
                Map<Integer, PriorityQueue<Integer>> columnValues = new HashMap<>();
                ...
                for (int i = 0; i < localSize; i++) {
                    ...
                    columnValues.putIfAbsent(col, new PriorityQueue<>());
                    columnValues.get(col).offer(node.val);
                ...
                for (int col : columnValues.keySet()) {
                    ArrayList<Integer> column = map.getOrDefault(col, new ArrayList<>());
                    PriorityQueue<Integer> values = columnValues.get(col);
